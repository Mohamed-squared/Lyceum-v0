...
// --- UTILITY FETCHER ---
// Update the fetcher function to include credentials and better error handling
async function fetcher(url: string, options?: RequestInit) {
  try {
    ...
    if (!res.ok) {
      ...
      throw new Error(errorInfo.message || `Request failed with status ${res.status}`)
    }
...
export const signIn = async (credentials: any) => {
  console.log("signIn called", credentials) /* Actual Supabase logic here */
}
export const signUp = async (credentials: any) => {
  console.log("signUp called", credentials) /* Actual Supabase logic here */
}
export const signOut = async () => {
  console.log("signOut called") /* Actual Supabase logic here */
}
export const sendPasswordResetEmail = async (email: string) => {
  console.log("sendPasswordResetEmail called", email) /* Actual Supabase logic here */
}
export const resetPassword = async (token: string, password: string) => {
  console.log("resetPassword called", token) /* Actual Supabase logic here */
}
...
export const getChapter = (courseId: string, chapterId: string) =>
  fetcher(`/api/courses/${courseId}/study/${chapterId}`)
...
export const sendPartnerRequest = (toUserId: string) =>
  fetcher("/api/community/partners/request", { method: "POST", body: JSON.stringify({ to_user_id: toUserId }) })
export const acceptPartnerRequest = (requestId: string) =>
  fetcher("/api/community/partners/accept", { method: "POST", body: JSON.stringify({ requestId }) })
export const declinePartnerRequest = (requestId: string) =>
  fetcher("/api/community/partners/decline", { method: "POST", body: JSON.stringify({ requestId }) })

// Settings
export const changeEmail = (data: any) => fetcher("/api/settings/email", { method: "POST", body: JSON.stringify(data) })
export const changePassword = (data: any) =>
  fetcher("/api/settings/password", { method: "POST", body: JSON.stringify(data) })
...
export const createChallenge = async (data: any) => {
  console.log("createChallenge called", data)
}
export const createCourse = async (data: any) => {
  console.log("createCourse called", data)
}
export const completeOnboarding = async (data: any) => {
  console.log("completeOnboarding called", data)
}
